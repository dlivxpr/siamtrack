...
trackers = ['Ocean-offline-25.9M', 'SiamRPN++-11.2M', 'DaSiamRPN-19.6M', 'SiamDW-34M', 'SiamBAN-10.8M',
            'LightTrack-1.97M', 'SiamMask-16.6M']
speed = np.array([72, 35, 160, 67, 40, 52.6, 120])
params = np.array([518, 224, 392, 680, 216, 39.4, 332])
performance = np.array([0.273, 0.285, 0.276, 0.299, 0.327, 0.333, 0.287])
