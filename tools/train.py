...
from siamese.utils.lr_scheduler import build_lr_scheduler
from siamese.utils.log_helper import init_log, print_speed, add_file_handler
from siamese.utils.distributed import dist_init, DistModule, reduce_gradients, \
    average_reduce, get_rank, get_world_size
from siamese.utils.model_load import load_pretrain, restore_from
from siamese.utils.average_meter import AverageMeter
from siamese.utils.misc import describe, commit
from siamese.models.model_builder import ModelBuilder
from siamese.datasets.dataset import BANDataset
from siamese.core.config import cfg

logger = logging.getLogger('global')
parser = argparse.ArgumentParser(description='siamese tracking')
parser.add_argument('--cfg', type=str, default='../experiments/resnet50_all/config.yaml',
